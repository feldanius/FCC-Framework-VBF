...
class RDFanalysis:
   ...
   #########
      ...
      df = df.Define(
         ...
         "FCCAnalyses::ReconstructedParticle::remove(ReconstructedParticles,electronss)",
         )
 ...
 ## perform N=2 jet clustering
      ...
      df = df.Define("higgs_muons", "Vec_rp{higgsbuilder_result_muons[1],higgsbuilder_result_muons[2]}") # the leptons 
      df = df.Define("higgs_electrons", "Vec_rp{higgsbuilder_result_electrons[1],higgsbuilder_result_electrons[2]}") # the leptons 
      ...
      df = df.Define("higgs_muons_p_m", "FCCAnalyses::ReconstructedParticle::get_p(higgs_muons)")
      df = df.Define("higgs_muons_p_e", "FCCAnalyses::ReconstructedParticle::get_p(higgs_electrons)")
