...
outputDir   = "/eos/user/f/fdmartin/FCC365_jets_b_tagging_cut_mjj-mH_30Gev"
...
def build_graph(df, dataset):
    ...
    results.append(df.Histo1D(("scoresum_B", "", *bins_score), "scoresum_B", "event_weight"))
    #########
    ### CUT : cut jj_m
    #########
    ...
    results.append(df.Histo1D(("jj_m", "", *bins_m_jj), "jj_m", "event_weight"))
    results.append(df.Histo1D(("missingEnergy_energy", "", *bins_recoil), "missingEnergy.energy", "event_weight"))
